        ...
        <div className="glass-effect rounded-3xl p-10 md:p-12">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                I am <span className="font-semibold">Gitanjali Arora</span>, a spiritual teacher and meditation guide. My journey began with a deep desire to bring families closer — not just in words, but in vibrations.
              </p>
              <p>
