      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end">
          ...
          {showMeetOptions && (
            ...
            >
              ...
              <motion.button
                ...
                className="group flex items-center gap-3 bg-white hover:bg-orange-50 text-orange-600 px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-orange-300"
              ...
              <motion.a
                ...
                className="group flex items-center gap-3 bg-white hover:bg-blue-50 text-gray-700 px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200"
        ...
        <div className="flex flex-col gap-3">
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] flex items-center justify-center text-white shadow-lg hover:shadow-2xl transition-all duration-300"
          ...
          <motion.button
            ...
            className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 ${
              showMeetOptions
                ? 'bg-gray-700'
